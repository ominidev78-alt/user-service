...
const options = {
  definition: {
    openapi: '3.0.0',
    info: {
      title: 'Pagandu Fintech USER SERVICE API',
      version: '1.0.0',
      description:
        'Documentação completa do microserviço de usuários, incluindo perfis, taxas e administração.'
    },
    servers: [
      {
      ...
      schemas: {
        User: {
          ...
          properties: {
            ...
            app_id: { type: 'string', example: 'pg_live_892384923849238', nullable: true },
...
<head>
  <meta charset="UTF-8" />
  <title>Pagandu Fintech USER SERVICE API</title>
