...
export const env = {
  ...
  JWT_USER_SECRET:
    process.env.JWT_USER_SECRET || process.env.JWT_OPERATOR_SECRET || 'pagandu-secret-2025',
  ...
  AUTH_SERVICE_URL: process.env.AUTH_SERVICE_URL || 'https://auth.pagandu.com',
  WALLET_SERVICE_URL: process.env.WALLET_SERVICE_URL || 'https://wallet.pagandu.com',
};
