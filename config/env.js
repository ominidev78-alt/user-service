...
export const env = {
  ...
  JWT_USER_SECRET:
    process.env.JWT_USER_SECRET || process.env.JWT_OPERATOR_SECRET || 'mutual-secret-2025',
  ...
  AUTH_SERVICE_URL: process.env.AUTH_SERVICE_URL || 'https://auth-service.omnigateway.site',
  WALLET_SERVICE_URL: process.env.WALLET_SERVICE_URL || 'https://wallet-service.omnigateway.site',
};
